...
describe("ShortcutClose.vue", () => {
  it("renders ESC shortcut text", async () => {
    const ShortcutClose = (await import("@components/word-search/shortcuts/ShortcutClose.vue"))
      .default;
...
describe("ShortcutNavigating.vue", () => {
  it("renders navigation shortcut", async () => {
    const ShortcutNavigating = (
      await import("@components/word-search/shortcuts/ShortcutNavigating.vue")
    ).default;
...
describe("ShortcutSelect.vue", () => {
  it("renders select shortcut", async () => {
    const ShortcutSelect = (await import("@components/word-search/shortcuts/ShortcutSelect.vue"))
      .default;
