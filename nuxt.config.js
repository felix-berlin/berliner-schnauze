...
export default {
  ...
  pwa: {
    ...
    manifest: {
      ...
      start_url: process.env.NODE_ENV === 'production' ? 'https://pwa.berliner-schnauze.pages.dev/' : 'http://localhost:3000/',
    ...
    workbox: {
      ...
      preCaching: ['/suggest-word', '/imprint', '/privacy-policy', '/workbox/workbox-sw.js'],
      config: {
