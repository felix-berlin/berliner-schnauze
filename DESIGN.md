...
**The One Red Rule.** Berlin Red is the brand's own color, not a general-purpose accent. It shows up rarely — logo, brand marks, one or two declarative UI moments — so that when it appears, it still reads as _the_ color, not _a_ color.
