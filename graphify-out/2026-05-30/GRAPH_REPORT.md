...
## Corpus Check
- 166 files · ~56,991 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 842 nodes · 1069 edges · 108 communities (62 shown, 46 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b625965`
...
Cohesion: 0.08
Nodes (23): ModalCloseButton, button, strong, wrapper, DarkMode, $isDarkMode, stores/index.ts (barrel export), close() (+15 more)
...
Cohesion: 0.04
Nodes (37): ~icons/lucide/chevron-right, currentModal, hasView, props, view, viewIsComponent, {
  buckets,
  clearAll,
  clearBucket,
  isCacheAvailable,
...
Cohesion: 0.10
Nodes (17): ~icons/lucide/external-link, @components/BadgeTag.vue, @components/ImageGallery.astro, @components/RandomWordButton.vue, @components/RelatedWords.vue, @components/ToolTip.vue, @components/word/IsWordOfTheDay.vue, @components/word/WordExamples.vue (+9 more)

### Community 14 - "Visual Feedback Components"
Cohesion: 0.05
Nodes (39): /fonts/Berlin-Bold.woff2, /fonts/Berlin-Italic.woff2, /fonts/Berlin.woff2, /fonts/BerlinerRegular.woff2, /fonts/BerlinX-Bold.woff2, canonicalURL, RandomWordButton, RelatedWords (+31 more)
...
Cohesion: 0.11
Nodes (11): SearchWords, activeIndex, mutableOramaSearch, oramaSearch, showActive, virtualizerRef, @components/word-search/WordSearchList.vue, $searchResultCount (+3 more)
...
Cohesion: 0.18
Nodes (7): SetColorMode, ThemeInitializationLogic, button, setLetterFilter(), setWordTypeFilter(), $toggleBerolinismus(), useViewTransition()
...
Cohesion: 0.20
Nodes (6): AlertBanner, isSending, isVerified, sendMailMutation, SendEmailDocument, page
...
Cohesion: 0.25
Nodes (9): useCacheStorage(), registerSW() call, createToast(), createToastNotify(), hidePopover(), removeToastById(), supportsPopover(), ToastPayload (+1 more)
...
Cohesion: 0.05
Nodes (28): computedState, X, milliseconds, breakpoints, largerThanSm, preferredMotion, searchLinkIconWrapClass, options (+20 more)
...
Cohesion: 0.20
Nodes (6): hideDropdown, wordSearch, wordSearch, wordSearch, $wordSearch, activeFilterCount
...
## Knowledge Gaps
- **404 isolated node(s):** `CircleCheck`, `CircleX`, `Clock`, `Loader`, `{
  buckets,
  clearAll,
  clearBucket,
  isCacheAvailable,
...
- **Why does `@layouts/Layout.astro` connect `PWA Cache Management` to `Word Detail Page`, `Visual Feedback Components`, `Dark Mode Store`, `Community 24`, `Community 26`, `Form & Auth Components`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `@/gql/graphql.ts` connect `GraphQL Type Definitions` to `GQL Fragment Masking`, `PWA Cache Management`, `Word Query Layer`, `Community 21`, `Form & Auth Components`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `@components/word-search/WordFilter.vue` connect `Dark Mode Store` to `Community 99`, `Community 21`, `Word Index Page`?**
...
- **What connects `CircleCheck`, `CircleX`, `Clock` to the rest of the system?**
