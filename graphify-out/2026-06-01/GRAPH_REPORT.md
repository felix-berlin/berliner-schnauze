...
## Corpus Check
- 166 files · ~57,010 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 842 nodes · 1071 edges · 103 communities (57 shown, 46 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c30a5b2f`
...
Cohesion: 0.06
Nodes (41): Moon, Sun, button, dom, html, wrapper, toggleMode, CookieConsent (+33 more)
...
Nodes (15): {
  ...
  swInfo,
  totalSizeBytes,
}, CircleCheck, CircleX, Clock, Component, ConfirmDialog, isPwaInstalled, Loader (+7 more)
...
Cohesion: 0.29
Nodes (5): debouncedTrackSearch, localSearch, searchInput, searchLength, searchResultCount

### Community 17 - "Search Filter Behaviour"
Cohesion: 0.05
Nodes (33): ~icons/lucide/chevron-right, currentModal, hasView, props, view, viewIsComponent, wrapper, milliseconds (+25 more)
...
## Knowledge Gaps
- **406 isolated node(s):** `isIndex`, `@styles/components/_menu-nav.scss`, `@components/ColorModeToggle.vue`, `@components/header/MainMenu.vue`, `@components/MainMenuButton.vue` (+401 more)
...
- **Why does `@layouts/Layout.astro` connect `Search Filter Behaviour` to `Word of the Day`, `PWA Cache Management`, `Word Detail Page`, `Visual Feedback Components`, `Community 24`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `@/gql/graphql.ts` connect `GraphQL Type Definitions` to `Site Layout & Footer`, `GQL Fragment Masking`, `Word Query Layer`, `Search Filter Behaviour`, `Community 21`?**
...
- **What connects `isIndex`, `@styles/components/_menu-nav.scss`, `@components/ColorModeToggle.vue` to the rest of the system?**
