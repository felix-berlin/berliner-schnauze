...
## Corpus Check
- 217 files · ~70,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 972 nodes · 1249 edges · 134 communities (79 shown, 55 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c9743b92`
...
Cohesion: 0.11
Nodes (13): ~icons/lucide/chevron-right, page, GetAllWordsLinksQuery, @components/PwaCacheOverview.vue, @/gql/graphql, @layouts/Layout.astro, @services/api.ts, @styles/components/_word-group.scss (+5 more)
...
Cohesion: 0.05
Nodes (23): computedState, X, activeIndex, mutableOramaSearch, oramaSearch, showActive, virtualizerRef, options (+15 more)
...
Cohesion: 0.22
Nodes (5): cardNumber, cardTransitionName, hasSavedGame, isShaking, savedGame
...
Cohesion: 0.20
Nodes (13): fetchAllWords(), extractWordTypes(), GET(), hypher, makeOramaSearchIndex(), OramaSearchIndex, GET(), hypher (+5 more)
...
Cohesion: 0.20
Nodes (7): fetchWikimediaAPI(), mockWords, result, coloredConsonantsAndVowels(), createWikimediaFileList(), similarWords(), mockFetch
...
## Knowledge Gaps
- **451 isolated node(s):** `Share2Icon`, `RefreshCwIcon`, `{ share: _share, isSupported: canShare }`, `accuracyPercent`, `page` (+446 more)
...
- **Why does `@layouts/Layout.astro` connect `PWA Cache Management` to `Site Layout & Footer`, `Toast Container`, `Word of the Day`, `Community 10`, `Word Detail Page`, `Community 23`, `Community 126`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `@/gql/graphql.ts` connect `GraphQL Type Definitions` to `Community 131`, `GQL Fragment Masking`, `Community 10`, `Word Query Layer`, `Community 86`, `Community 126`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `trackEvent()` connect `Community 43` to `Community 32`, `Community 34`, `Community 131`, `Word List Filtering`, `Search Input Logic`, `Community 113`, `Audio Playback Controls`, `Community 116`, `Community 117`, `Community 21`, `Community 24`?**
...
- **What connects `Share2Icon`, `RefreshCwIcon`, `{ share: _share, isSupported: canShare }` to the rest of the system?**
