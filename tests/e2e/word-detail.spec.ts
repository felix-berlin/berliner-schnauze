...
test.describe('Wort-Detailseite (/wort/<slug>)', () => {
  ...
  test('umfangreiches Wort zeigt vollständige Phonologie-Section (anmachen)', async ({
    page,
  }) => {
    ...
    await expect(phonologie.getByRole('heading', { name: 'Ähnlich klingende Wörter' })).toBeVisible();
